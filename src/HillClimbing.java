...
public class HillClimbing {
    ...
    public static void main(String[] args)throws IOException{
        ...
        LocalSearch1(file, 3, 0);
        LocalSearch1(file, 3, 11);
        LocalSearch1(file, 3, 13);
        LocalSearch1(file, 3, 17);
        LocalSearch1(file, 3, 23);
        LocalSearch1(file, 3, 27);
        LocalSearch1(file, 3, 31);
        LocalSearch1(file, 3, 37);
        LocalSearch1(file, 3, 41);
        LocalSearch1(file, 3, 47);
    }
